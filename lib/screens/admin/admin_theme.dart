...
// ═══════════════════════════════════════════════════════════════════
// LAUNDRIFY ADMIN THEME — White UI matching User Dashboard
// Clean white surfaces with Navy + Gold accents
// ═══════════════════════════════════════════════════════════════════
...
class AdminStatCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Text(value, style: AdminTheme.heading(26)),
      const SizedBox(height: 4),
      Text(title, style: AdminTheme.label(13)),
      if (subtitle != null) ...[const SizedBox(height: 4),
        Text(subtitle!, style: AdminTheme.label(11).copyWith(color: AdminTheme.textMuted))],
    ]),
  );
}
...
class AdminPageHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Row(children: [
    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Text(title, style: AdminTheme.heading(22)),
      const SizedBox(height: 4),
      Text(subtitle, style: AdminTheme.label(13)),
    ])),
