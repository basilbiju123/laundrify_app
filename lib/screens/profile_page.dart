...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final initials =
        (_userData['name'] as String? ?? user?.displayName ?? 'U')
            .split(' ')
            ...
            if (_isEditing) ...[
                ...
                child: Column(
                  children: [
                    ...
                    _infoRow(
                      ...
                      'Email Verified',
                      user?.emailVerified ?? false ? '✅ Verified' : '⚠️ Not verified',
                    ),
                  ],
                ),
              ),
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    _statCol('Total Orders',
                        '${_userData['totalOrders'] ?? 0}',
                        Icons.shopping_bag_rounded, _gold),
                    Container(width: 1, height: 40, color: const Color(0xFFE8EDF5)),
                    _statCol('Loyalty Points',
                        '${_userData['loyaltyPoints'] ?? 0}',
                        Icons.stars_rounded, const Color(0xFF8B5CF6)),
                    Container(width: 1, height: 40, color: const Color(0xFFE8EDF5)),
